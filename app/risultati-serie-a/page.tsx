                            ...
                            return (
                              <div key={i} className="mb-6">
                                <div className="flex justify-between text-xs mb-2 items-end">
                                  <span className="text-white font-black drop-shadow-[0_1px_3px_rgba(0,0,0,1)] text-lg italic">{stat.stats[0]}</span>
                                  <span className="text-slate-500 uppercase tracking-widest text-[10px] font-black pb-1">{trTitle}</span>
                                  <span className="text-white font-black drop-shadow-[0_1px_3px_rgba(0,0,0,1)] text-lg italic">{stat.stats[1]}</span>
                                </div>
