...
const FASCE: Fascia[] = [
    {
        ...
        pece: "#C4D8E4", calce: "#08202B", fondale: "#E8F1F6", secca: "#AFCADB",
        ...
        lario: "#0F5378", vermiglio: "#C4381E", oro: "#9C6A08",
        acqua: ["#8FB6CE", "#6D9DBC", "#4C82A6"],
        cielo: ["#D9D2C6", "#B4CFE0"],
    },
    {
        id: "giorno", nome: "giorno", chiara: true,
        pece: "#C6DAE6", calce: "#061618", fondale: "#E9F2F7", secca: "#ADC9DC",
        ...
        lario: "#0F5C86", vermiglio: "#C8371C", oro: "#94660A",
    ...
    },
    {
        ...
        lario: "#3F9FD4", vermiglio: "#F2543D", oro: "#F0B429",
    ...
    },
    {
        ...
        lario: "#2E8FC4", vermiglio: "#EF4A34", oro: "#E0A32B",
